          ...
          <div className={styles.bodyText}>
            {page?.aboutBody ? (
              ...
              <>
                ...
                <p>
                  We&apos;re locals — we know Melbourne&apos;s commercial landscape, its businesses,
                  and what it takes to create spaces that work as hard as the people in them.
                  Whether you&apos;re starting fresh or reimagining an existing space, we&apos;re
